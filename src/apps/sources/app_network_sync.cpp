...
public:
    ...
    void onLoop() override {
        ...
        if (m_state != last_drawn_state || anim_dots != last_drawn_dots) {
            ...
            bool show_dots = (m_state == 0 || m_state == 1 || m_state == 4);
            drawCenteredText(UIStrings::NetworkSyncPrimary(lang, m_state), UIStrings::NetworkSyncSecondary(lang, m_state), show_dots);
        }
    }
